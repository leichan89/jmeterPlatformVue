    ...
    submit() {
      this.$refs.createJmxFormRef.validate(async valid => {
        ...
        if (createJmxRes.code !== 200) {
          ...
          // 创建头信息
          this.$refs.header.headerParamFormData.samplerId = createJmxRes.data.samplerId
          ...
          if (createHeaderRes.code !== 200) {
            ...
            // 创建响应断言
            this.$refs.rspparamRef.rspAssertParamFormData.samplerId = createJmxRes.data.samplerId
